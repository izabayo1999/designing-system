      <?php
        ...
        ?>
      <div class="col-lg-10 main-side-pro">
                              ...
                              <div class="col-lg-6 col-md-1 col-sm-1 col-xs-12">
                                  <div class="header-top-menu tabl-d-n">
                                      <ul class="nav navbar-nav mai-top-nav">
                                          ...
                                          <li class="nav-item"><a href="all-death-application.php" class="nav-link">All
                                                  Applications</a>
                                          </li>
                                          <li class="nav-item"><a href="between-dates-report.php"
                                                  class="nav-link">Report</a>
                                          </li>
                                      ...
                                      <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                          <li class="nav-item">
                                              <a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                                                  ...
                                                  <span
                                                      class="author-project-icon adminpro-icon adminpro-down-arrow"></span><?php $cnt = $cnt + 1;
                                                                                                                                        }
                                                                                                                                    } ?>
                                              </a>
                                              <ul role="menu"
                                                  ...
                                                  <li><a href="change-password.php"><span
