...
<head>
    ...
    <title>Between Dates Report | Online Death Registration</title>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="all-form-element-inner">
                                                        ...
                                                        <form method="post" name="bwdatesreport"
                                                            action="application-bwdates-reports-details.php">

                                                            <div class="form-group-inner">
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <label
                                                                            class="login2 pull-right pull-right-pro">From
                                                                            Date:</label>
                                                                    </div>
                                                                    <div class="col-lg-9">
                                                            ...
                                                            <div class="form-group-inner">
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <label
                                                                            class="login2 pull-right pull-right-pro">To
                                                                            Date:</label>
                                                                    </div>
                                                                    <div class="col-lg-9">
                                                                        <input type="date" class="form-control"
