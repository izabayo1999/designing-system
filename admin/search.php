...
<head>
    ...
    <title>Search | Online Death Registration</title>
            ...
            <div class="row">
                ...
                <div class="data-table-area mg-b-15">
                    <div class="container-fluid">
                                        ...
                                        <div class="datatable-dashv1-list custom-datatable-overright">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <label class="login2 pull-right pull-right-pro">Search by
                        ...
                        ?>
                                            <h4 align="center">Result against "<b><?php echo $sdata; ?></b>" Application
                                            </h4>
