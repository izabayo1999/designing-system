...
<head>
    ...
    <title>Profile | Online Death Registration</title>
                                  ...
                                  foreach ($results as $row) {               ?>
                                                            <div class="form-group-inner">
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <label
                                                                            class="login2 pull-right pull-right-pro">First
                                                                            Name</label>
                                                                    </div>
                                                                    <div class="col-lg-9">
                                                            ...
                                                            <div class="form-group-inner">
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <label
                                                                            class="login2 pull-right pull-right-pro">Last
                                                                            Name</label>
                                                                    </div>
                                                                    <div class="col-lg-9">
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <textarea type="text" class="form-control"
                                                                            name="add"
                                                                            value="" /><?php echo $row->Address; ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group-inner">
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <label
                                                                            class="login2 pull-right pull-right-pro">Registration
                                                                            Date</label>
                                                                    </div>
                                                                    <div class="col-lg-9">
                                                                        <input type="text" class="form-control"
