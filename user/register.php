...
<head>
    ...
    <title>Register | Online Death Registration</title>
                        ...
                        <div class="col-lg-6">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="logo">
                                            <h3 style="font-weight: bold;color: blue">Online Death Registration</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="mobno" maxlength="10" pattern="[0-9]+"
                                                required="true" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            ...
                                            <i class="fa fa-location-arrow login-user" aria-hidden="true"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
